...
// node_modules/windicss/utils/index.mjs
...
function isNumber(amount, start, end, type2) {
  if (start === void 0) {
    start = -Infinity;
  }
  if (end === void 0) {
...
var Property = (
  ...
  function() {
    ...
    Property2.prototype.updateMeta = function(type2, group, order, offset, corePlugin) {
      if (offset === void 0) {
        offset = 0;
      }
...
var Style = (
  ...
  function() {
    ...
    Style2.prototype.updateMeta = function(type2, group, order, offset, corePlugin, respectSelector) {
      if (offset === void 0) {
        offset = 0;
      }
      if (corePlugin === void 0) {
  ...
  if (Array.isArray(style)) {
    if (mode === "media")
      return style.map(function(i) {
        return new Style().atRule("@media (prefers-color-scheme: dark)").extend(i);
      });
    return style.map(function(i) {
      return new Style().parent(".dark").extend(i);
    });
  }
  if (mode === "media")
...
function generateCompletions(processor) {
  ...
  var _loop_1 = function(config2, list2) {
    list2.forEach(function(utility) {
      ...
      if (mark === -1) {
        ...
        switch (suffix) {
          case "${static}":
            completions.static = completions.static.concat(Object.keys(processor.theme(config2, {})).map(function(i) {
              return i === "DEFAULT" ? prefix_1 : i.charAt(0) === "-" ? "-".concat(prefix_1).concat(i) : "".concat(prefix_1, "-").concat(i);
            }));
            break;
          case "${color}":
            for (var _i2 = 0, _a2 = Object.keys(flatColors(processor.theme(config2, colors))); _i2 < _a2.length; _i2++) {
              var key = _a2[_i2];
              if (key !== "DEFAULT")
...
windicss/utils/index.mjs:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=windicss_utils.js.map
